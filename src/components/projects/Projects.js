          ...
          <div className="projectcase">
            ...
            <div className="gallery">
              <figure className="gallery__item gallery__item--1">
                <a href="https://github.com/Quintam26/app-layout-redesign/tree/dev" target="_blank" rel="noopener noreferrer"><img src={require('../../assets/reaction.png')} className="gallery__img" alt="Image 1"/></a>
              </figure>
              <br/>
              ...
              <figure className="gallery__item gallery__item--5">
                <a href="https://github.com/Quintam26/Edge" target="_blank" rel="noopener noreferrer"><img src={require('../../assets/edge.png')} className="gallery__img" alt="Image 5"/></a>
              </figure>
